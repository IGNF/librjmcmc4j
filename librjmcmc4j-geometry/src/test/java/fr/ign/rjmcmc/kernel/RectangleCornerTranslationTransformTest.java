...
public class RectangleCornerTranslationTransformTest {
  ...
  public void testDimension() {
    Assert.assertEquals(7, t.dimension(5,5));
  }

  @Test
  public void testApply() {
    Vector<Double> val0 = new Vector<>(Arrays.asList(0., 0., 1., 0., 1.));
    Vector<Double> var0 = new Vector<>(Arrays.asList(0., 1. ));
...
//    }
  ...
  public void testInverse() {
    Vector<Double> val0 = new Vector<>(Arrays.asList(0., 0., 1., 0., 1.));
    Vector<Double> var0 = new Vector<>(Arrays.asList(1., 1. ));
    Vector<Double> val1 = new Vector<>();
    val1.setSize(5);
    Vector<Double> var1 = new Vector<>();
    var1.setSize(2);
...
//    }
    ...
    Assert.assertArrayEquals(Util.toArray(var0), Util.toArray(var2), 0.001);
  }
}
