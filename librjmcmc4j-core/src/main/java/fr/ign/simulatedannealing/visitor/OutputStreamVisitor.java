...
public class OutputStreamVisitor<C extends Configuration<C, M>, M extends Modification<C, M>> implements Visitor<C, M> {
  ...
  public void visit(C config, Sampler<C, M> sampler, Temperature t) {
    ...
    time += sampler.getTimeAcceptance() + sampler.getTimeApply() + sampler.getTimeDelta() + sampler.getTimeGreenRatio() + sampler.getTimeRandomApply();
